...
class MainActivity : AppCompatActivity(), NoteListener, SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainBinding.layoutChoose.setOnClickListener {
            val controller =
            ...
            if (isLinearLayoutManager) {
                Log.d("L","list view ")
                //.title = "GridView"
                mainBinding.layoutChoose.setImageResource(R.drawable.ic_listview)
                mainBinding.layoutChoose.contentDescription = "List View"
                editor!!.putString("HEY", "True")
                editor!!.apply()
            } else {
                Log.d("L","grid view ")
                mainBinding.layoutChoose.setImageResource(R.drawable.ic_gridview)
                mainBinding.layoutChoose.contentDescription = "Grid View"
                    ...
                    if (counter == 0) {
                        ...
                        if (counter == noteList.size) {
                            ...
                            materialAlertDialog.setTitle("Delete Note")
                                ...
                                .setPositiveButton("Delete") { dialog, id ->
//                                    for(i in 0..counter){
//                                        Log.d("ACTION","c: $counter")
//                                        if(selectedItem!!.get(i)) {
//                                            noteViewModel.delete(noteList[i])
//                                            Log.d("ACTION", "pos : $i")
//                                        }
//                                    }
...
//                                        Log.d(
//                                            "ACTION",
//                                            "Selected $b $i ${selectedItem!!.indexOf(i)}"
//                                        )
//                                        b++
//                                        if(i){
//                                            Log.d("ACTION","Selected size ${selectedItem!!.size} and pos $i and ${selectedItem!!.indexOf(i)}")
